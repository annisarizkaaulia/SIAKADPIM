      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-body card-block">
            <form action="<?= base_url('master/editsubmitJurusan/'.$id_jur)?>" method="POST">
              <?= csrf_field(); ?>
              <div class="mb-3 row">
                <label for="kode_jur" class="col-sm-2 col-form-label">Kode jurusan</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control <?= ($validation->hasError('kode_jur')) ? 'is-invalid': '';?>" id="kode_jur" name="kode_jur"
                    placeholder="Masukkan kode jurusan" value="<?= (old('kode_jur')) ? old('kode_jur') : $jurusanloop->kode_jur ?>">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control <?= ($validation->hasError('nama_jur')) ? 'is-invalid': '';?>" id="nama_jur" name="nama_jur"
                    placeholder="Masukkan nama jurusan" value="<?= (old('nama_jur')) ? old('nama_jur') : $jurusanloop->nama_jur ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control <?= ($validation->hasError('nama_kajur')) ? 'is-invalid': '';?>" id="nama_kajur" name="nama_kajur"
                    placeholder="Masukkan nama jurusan" value="<?= (old('nama_kajur')) ? old('nama_kajur') : $jurusanloop->nama_kajur ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control <?= ($validation->hasError('nip_kajur')) ? 'is-invalid': '';?>" id="nip_kajur" name="nip_kajur"
                    placeholder="Masukkan nama jurusan" value="<?= (old('nip_kajur')) ? old('nip_kajur') : $jurusanloop->nip_kajur ?>">
                  <div class="invalid-feedback">
