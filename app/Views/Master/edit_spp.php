      ...
      <div class="col-md-6 offset-md-3">
        <div class="card">
          <div class="card-body card-block">
            <form action="<?= base_url('master/editsubmitSpp/'.$id_spp)?>" method="POST">
              <?= csrf_field(); ?>
              <div class="mb-3 row">
                <label for="tanggal" class="col-sm-3 col-form-label">Tanggal</label>
                <div class="col-sm-6">
                  <input type="date" class="form-control" id="tanggal" name="tanggal"
                    value="<?= (old('tanggal')) ? old('tanggal') : $spploop->tanggal ?>">
                </div>
              </div>
              <div class="mb-3 row">
                ...
                <div class="col-sm-6">
                  <select name="nim" id="nim" class="form-control">
                    ...
                    <option value="<?= $col1->nim?>" <?php if($spploop->nim == $col1->nim) echo "selected"?>>
                      <?= $col1->nim." - ".$col1->nama ?>
                    </option>
                    <?php endforeach ?>
                  </select>
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-6">
                  <select name="tipe" id="tipe" class="form-control">
                    ...
                    <option value="1" <?php if($spploop->tipe == "1") echo "selected"?>>Debet</option>
                    <option value="2" <?php if($spploop->tipe == "2") echo "selected"?>>Kredit</option>
                  </select>
                </div>
              </div>
              <div class="mb-3 row">
                ...
                <div class="col col-md-6">
                  <div class="input-group">
                    ...
                    <input type="text"
                      class="form-control" id="jumlah_spp" name="jumlah_spp" value="<?= (old('jumlah_spp')) ? old('jumlah_spp') : $spploop->jumlah_spp ?>">
                  </div>
                </div>
              </div>
