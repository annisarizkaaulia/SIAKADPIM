      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-body card-block">
            <form action="<?= base_url('master/editsubmitMatkul/'.$id_matkul)?>" method="POST">
            <?= csrf_field(); ?>
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control <?= ($validation->hasError('kode_matkul')) ? 'is-invalid': '';?>" id="kode_matkul" name="kode_matkul"
                    placeholder="Masukkan kode mata kuliah" value="<?= (old('kode_matkul')) ? old('kode_matkul') : $matkulloop->kode_matkul ?>">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control <?= ($validation->hasError('nama_matkul')) ? 'is-invalid': '';?>" id="nama_matkul" name="nama_matkul"
                    placeholder="Masukkan nama mata kuliah" value="<?= (old('nama_matkul')) ? old('nama_matkul') : $matkulloop->nama_matkul ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  ...
                  placeholder="sks mata kuliah" value="<?= (old('sks')) ? old('sks') : $matkulloop->sks ?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  ...
                  placeholder="jam mata kuliah" value="<?= (old('jam')) ? old('jam') : $matkulloop->jam ?>">
                  <div class="invalid-feedback">
                ...
                <div class="col-sm-10">
                  <select name="kode_pro" id="kode_pro" class="form-control <?= ($validation->hasError('kode_pro')) ? 'is-invalid': '';?>">
                    ...
                    <?php foreach ($prodimatkul as $col):?>
                        <option value="<?= $col->kode_pro?>" <?php if($matkulloop->kode_pro == $col->kode_pro) echo "selected"?>>
                          <?= $col->nama_pro?>
                        </option>
                    <?php endforeach; ?>
                  </select>
