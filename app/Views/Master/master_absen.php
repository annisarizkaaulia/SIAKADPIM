      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-body card-block">
            <form action="<?= base_url()?>/master/simpanAbsen" method="POST">
            <?= csrf_field(); ?>
              <div class="mb-3 row">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="time" class="form-control <?= ($validation->hasError('jam')) ? 'is-invalid': '';?>" id="jam" name="jam" value="<?= old('jam');?>">
                  <div class="invalid-feedback">
