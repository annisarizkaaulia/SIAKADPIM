      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-body card-block">
            <form action="<?= base_url()?>/master/simpanProdi" method="POST">
            <?= csrf_field(); ?>
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control <?= ($validation->hasError('kode_pro')) ? 'is-invalid': '';?>" id="kode_pro" name="kode_pro"
                    placeholder="Masukkan kode jurusan" value="<?= old('kode_pro');?>">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control <?= ($validation->hasError('nama_pro')) ? 'is-invalid': '';?>" id="nama_pro" name="nama_pro"
                    placeholder="Masukkan nama jurusan" value="<?= old('nama_pro');?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                <label for="nama_kapro" class="col-sm-2 col-form-label">Nama Ketua prodi</label>
                <div class="col-sm-10">
                  <input type="text" class="form-control <?= ($validation->hasError('nama_kapro')) ? 'is-invalid': '';?>" id="nama_kapro" name="nama_kapro"
                    placeholder="Masukkan nama ketua prodi" value="<?= old('nama_kapro');?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control <?= ($validation->hasError('jenjang')) ? 'is-invalid': '';?>" id="jenjang" name="jenjang" 
                  placeholder="Jenjang pendidikan" value="<?= old('jenjang');?>">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <select name="kode_jur" id="kode_jur" class="form-control <?= ($validation->hasError('kode_jur')) ? 'is-invalid': '';?>">
                    <option disabled selected>- Jurusan -</option>
                    <?php foreach ($jurusanprodi as $col):?>
                        <option value="<?= $col->kode_jur?>">
                          <?= $col->nama_jur?>
                        </option>
                    <?php endforeach; ?>
                  </select>
