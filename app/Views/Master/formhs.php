      ...
      <div class="col-lg-12">
        <div class="card">
          ...
          <div class="card-body card-block">
            <form action="<?= base_url()?>/master/simpanMhs" method="POST">
              <?= csrf_field(); ?>
              <div class="mb-3 row">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control" id="alamat" name="alamat"
                    placeholder="Masukkan domilisi anda">
                </div>
              </div>
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <select name="id_wilayah" id="id_wilayah" class="form-control">
                    ...
                    <?php foreach ($kecamatanmhs as $col):?>
                    <option value="<?= $col->id_wilayah?>">
                      <?= $col->nama_wilayah?>
                    </option>
                    <?php endforeach ?>
                  </select>
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control <?= ($validation->hasError('HP')) ? 'is-invalid': '';?>"
                    id="HP" name="HP" placeholder="Masukkan HP anda">
                  <div class="invalid-feedback">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <select name="kode_pro" id="kode_pro" class="form-control">
                    ...
                    <?php foreach ($prodimhs as $col1):?>
                    <option value="<?= $col1->kode_pro?>">
