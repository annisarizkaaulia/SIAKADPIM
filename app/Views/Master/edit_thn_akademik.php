      ...
      <div class="col-md-12">
        <div class="card">
          <div class="card-body card-block">
            <form action="<?= base_url('master/editsubmitTahunAkademik/'.$id_thn)?>" method="POST">
            <?= csrf_field(); ?>
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <input type="text" class="form-control <?= ($validation->hasError('thn_akademik')) ? 'is-invalid': '';?>" id="thn_akademik" name="thn_akademik"
                    placeholder="Masukkan kode mata kuliah" value="<?= (old('thn_akademik')) ? old('thn_akademik') : $thnakademikloop->thn_akademik ?>">
              ...
              <div class="mb-3 row">
                ...
                <div class="col-sm-10">
                  <select name="status" id="status" class="form-control">
                    <option>- Pilih -</option>
                    <option value="Aktif" <?php if($thnakademikloop->status == "Aktif") echo "selected"?>>Aktif</option>
                    <option value="Tidak aktif" <?php if($thnakademikloop->status == "Tidak aktif") echo "selected"?>>Tidak Aktif</option>
                  </select>
                </div>
              </div>
